...
- `party-combat-actions.png` is the transparent 384 × 384 runtime candidate: six rows, eight columns, 48 × 64 per cell.
- `party-combat-actions-contact-sheet.png` is a labeled 1268 × 1222 checkerboard review sheet and is not for runtime use.
