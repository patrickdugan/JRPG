...
- `party-combat-actions.png` is the transparent 432 × 384 runtime candidate: 6 rows, 9 columns, 48 × 64 per cell.
- `party-combat-actions-contact-sheet.png` is a labeled 1412 × 1222 checkerboard review sheet and is not for runtime use.
