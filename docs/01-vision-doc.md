...
Nikola, born around 1590, is the younger son of a fictional minor Croatian frontier house from the Senj–Brinje hinterland, but the house claims Wallachian origins and Nikola is also English through his mother, Margaret Wychmere, a fictional Catholic noblewoman from a family living in Adriatic exile. Its suspect genealogy advertises an unbroken father-to-son descent from an ancestor who rode in Vlad III Drăculea’s 1462 campaign against Mehmed II. The contracts contradict the boast. Wallachian covenant knowledge first enters through a noblewoman; two later heiresses require husbands or sons to assume the Dražanić name; Margaret’s marriage exchanges Wychmere money and maritime contacts for frontier protection and standing. Some of these women negotiate hard terms and some are plainly bartered, but none is merely a bridge between male names. The house’s so-called patrilineage is a legal performance repeatedly rebuilt through women.

In this alternate history, Vlad used vampirism as an emergency weapon against Ottoman conquest, survived the war, and then refused to surrender the power that had made him indispensable. Orthodox confessors, border soldiers, and ward-smiths created the fictional **Covenant of the Severed Dragon** to separate a blood ruler from the offices, armies, and objects bound to him. A defeated branch carried that consecrated wardcraft west and eventually took the South Slavic name Dražanić. The covenant is invented fantasy, not a claim about a real church rite, Vlad III, or the historical Order of the Dragon.

Nikola’s silver lance mounts the **Longinus point**: in the game’s alternate history it is the actual Roman iron that pierced Christ’s side after death, passed through contradictory Eastern and Adriatic custodial histories before the Dražanić family built it into a vampire-hunting weapon. Nikola boasts that he will kill Kurozane with “the spear that killed Christ”; Mateus immediately corrects both his theology and anatomy. The relic is an inherited burden and a check on rulers, never random loot, a collectible, or proof that Nikola’s family deserves authority. Its authenticity is true within the fantasy premise, while every surviving document about how the family acquired it remains self-serving and disputed.
...
* Do not use real victims, named historical officials, or additional actual sacred objects as boss fodder. The Longinus point is the one deliberate alternate-history relic premise; treat it as a grave inherited burden even when Nikola’s boast about it is played for character comedy.
