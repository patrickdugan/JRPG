...
| CHR-PARTY-013-019 | party portraits + emotion set | 7 x 8 expressions | P1 | neutral, resolve, strain, soften, concern, anger, surprise, quiet; original faces only. Live v2 uses 96 × 96 transparent cels, one shared 64-color visible palette, and explicit generated-source/deterministic-pixelification provenance. |
