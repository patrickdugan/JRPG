...
| VFX-SYS-001-013 | system feedback | 13 | P0 | Move, selected cell, blocked, Guard, Campaign Dodge commit/stance/resolution, Analyze, objectives, recovery lock, Tempo, exact published-line evasion, distinct non-locking victory/defeat accents, and typed damage-outcome flyouts are live. Campaign Dodge uses code-native chevrons and the existing move pose; route preview remains one-step and heal is dormant. |
