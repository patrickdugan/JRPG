...
| VFX-SYS-001-012 | system feedback | 12 | P0 | Move, selected cell, blocked, Guard, Analyze, objectives, recovery lock, Tempo, exact published-line evasion, distinct non-locking victory/defeat accents, and typed damage-outcome flyouts are live; route preview remains one-step, heal is dormant, and Campaign stance Dodge is absent. |
