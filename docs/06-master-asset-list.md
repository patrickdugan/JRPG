...
**Current authored-runtime status (2026-07-20):** all 19 current combat boards are authored: Takamine plus 18 regional boards. The party field atlas contains 84 unique frames (6 × 14) with paired directional walk phases plus live interact/hurt; every row is reachable through a selector bounded by each level's canonical formation, and the visible leader owns field-hazard vitals. Combat-action keys (6 × 10, including recovery and defeat) and portrait expressions (6 × 8) remain integrated. Runtime art also includes 19 transparent terrain overlays covering all 48 levels, eight regular-enemy families × seven poses, ten bosses × seven poses, nine delivery/essence VFX × six phase frames, six statuses × three lifecycle frames, 25 distinct item icons, and a four-role metadata-only NPC foundation. Procedural/generic/text/flat-color fallbacks remain. Remaining combat/scene in-betweens, alternate action facings, visible following formations, variants, the full named/generic NPC packages, an emitted Campaign heal, and stance-Dodge mechanics/presentation are still absent. Human readability review, external cultural review, and Accepted/art lock remain pending.
...
| CHR-PARTY-007-012 | party combat sprites | 6 | P0/P1 | idle, move, guard, hit, basic strike, 2 signature skills, defeat/retreat; 48 x 64 nominal. |
...
| VFX-SYS-001-012 | system feedback | 12 | P0 | Move, selected cell, blocked, Guard, Analyze, objectives, recovery lock, Tempo, exact published-line evasion, and distinct non-locking victory/defeat accents are live; route preview remains one-step, heal is dormant, and Campaign stance Dodge is absent. |
