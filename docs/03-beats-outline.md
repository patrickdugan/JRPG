...
**Campaign structure:** 60 authored story beats; Salt/Ash/Paper schedules play 55/54/55 of them. The v8 quantity audit's 193.429/319.314/514.408-minute range covers the full authored catalog, not one selected route.<br>
**Intended first-play route:** the story plus 215 entered-at-unlock activities; its quantity estimate is 784.234/1,243.367/1,934.830 minutes (about 13.07/20.72/32.25 hours), not measured playtime<br>
...
* The game is an alternate historical fantasy set in 1622, not a retelling of actual Japanese persecution or a story in which one culture “saves” another.
* Every chapter has a local quest with a beginning, a place to talk, a dungeon, a boss, and a clear consequence.
* The route is quest-led, not Metroidvania-led. Optional revisits yield materials, bonds, shortcuts, and lore; no required route depends on a movement upgrade.
* Every boss introduces or tests one readable Tempo/Pace/Recovery or damage-Ledger concept.
* The party does not defeat a system solely by killing its supernatural leader. They expose, interrupt, and replace the system’s local mechanisms.

## Campaign at a glance

| Chapter | Quest | Primary places | New party / relationship turn | Boss | Battle lesson |
| --- | --- | --- | --- | --- | --- |
...
**Quest:** Get three families out of Hoshigawa before Black Chrysanthemum inspectors ring the census bell.

**Places:** Ren’s delivery route; rain-soaked Hoshigawa lane; a sealed storehouse; riverbank escape trail.

**Major beats**

1. Ren returns with a state dispatch ordering an overnight census. The order is deliberately vague: it demands names, household ties, and any “foreign contamination.”
2. He sees Magistrate Ujiro Arata’s local collector add names to a black-lacquer ledger that does not match the written order.
3. A neighbor asks Ren to carry a child’s medicine across the lane; this teaches precise field movement, interaction range, and the idea that the player’s task is local and human.
4. The census bell rings once. A disappeared villager returns as an Ashen Bailiff, proving that the court’s violence has a supernatural component.
5. Ren and two civilians escape by the river. The player cannot save everyone; the scene frames this as a wound, not a failure state.
6. A fragment chips from the bell and burns Ren’s dispatch pouch. Aya Shinohara, arriving to inspect damaged shrine records, identifies it as a bell fragment marked for Takamine Temple.

**Boss:** Ashen Bailiff. It draws a long, red sweep before acting; moving two spaces out of the line is safer than attacking twice.

**Exit state:** Ren takes the fragment to Aya rather than report it. Hoshigawa is placed under watch.

## Chapter 1 — River of Names

**Quest:** Prove that the census ledger was falsified and locate the fragment’s intended destination.

**Places:** Hoshigawa’s shrine archive; ferry landing; flooded cedar route; abandoned tax storehouse.

**Characters:** Aya becomes permanent party member. Kiku appears as the village physician and quietly establishes that the Lantern Network consists of people with different faiths and reasons to help.

**Major beats**

1. Aya compares the local registry to Ren’s dispatch and finds missing households replaced with blank ink seals.
2. She refuses Ren’s first plan to raid the inspector post: the party needs the record, not merely revenge.
3. Town conversations reveal that a river ferry captain has been paid to deliver confiscated objects, including a bell fragment, uphill toward Takamine.
...
**Exit state:** The party leaves Hoshigawa by mountain road. Kiku stays to protect the village but gives Aya a Lantern Network code.
...
**Quest:** Move the temple witnesses through a port closed by the court and secure the first bell key.
...
5. Captain Kaji reveals the first key is sealed in a salt warehouse and orders the dock cranes turned into weapons.
6. Genta chooses to testify publicly to the prisoners before he joins the party, accepting that this will make him a traitor to the court.
...
**Quest:** Recover the second bell key from the wreck before the court’s divers do.
...
**Boss:** Widow-of-Fog. Frost-resistant and Ember-weak; it switches safe tiles between high tide and low tide phases.

**Exit state:** Second key secured. A rescued courier reports that Kagura Pass has begun producing Ashen Oni faster than villages can hide.

## Chapter 5 — Ash in Kagura Pass

**Quest:** Destroy the Oni forge and discover how the bell network produces soldiers.

**Places:** Kagura relay station; ash fields; volcano-side forge; archive furnace.

**Major beats**

1. The party reaches a relay town whose residents are forced to feed coal to a “civil protection” furnace.
2. Genta recognizes military requisition marks and identifies the forge’s supply chain, confirming that human bureaucracy—not just magic—sustains Kurozane.
3. The Ashen Oni are shown to be people whose names were stripped from the registry and bound into ash armor. The party’s goal becomes release, not mass extermination.
4. Mateus finds his own cipher on the furnace directives. He tells the full truth: he designed a translation code that made forced denunciations legible to the vampire court.
5. Ren nearly expels him. Aya insists the group can use the truth without declaring him forgiven.
6. The Furnace Abbot, an Oni command construct, offers Mateus a return to comfort and threatens the town’s children. Mateus burns his court sigil to open the prison locks.
7. The forge destruction releases records proving Ujiro and Kurozane engineered raids to increase bell fuel. This is the campaign midpoint: the ban is being weaponized by a specific court for supernatural control.

**Boss:** Furnace Abbot. It absorbs Ember, resists Crush, and overheats after its Forge Sermon, yielding a recovery window. The optimal solution uses Frost terrain, Pierce attacks, and deliberate timing.

**Exit state:** The forge is shut down; the third key is not there. Ujiro has taken it to Kōzui for a public tribunal designed to erase the evidence.

## Chapter 6 — The Court of Masks

**Quest:** Put the forge evidence into public hands before Ujiro’s tribunal destroys it.

**Places:** Kōzui relay city; printmaker lane; public tribunal; archive roof; canal lock.

**Major beats**

1. The party enters a bustling city where everyday merchants, officials, and neighbors are negotiating survival rather than uniformly supporting or resisting the court.
...
**Exit state:** Third key secured, but the party learns that breaking the nodes will not save those already scheduled for the final ringing.

## Chapter 7 — The Road of the Dead

**Quest:** Rescue people being taken through Hushroad before Kurozane can complete the Yearless Bell.

**Places:** Hushroad tunnel; abandoned post town; prison ferry; subterranean bell aqueduct.
...
**Boss:** Bell Warden Chiyo. Break chains, shift allies into extraction zones, and stop a countdown. Killing the boss without freeing captives is a tactical loss; the encounter restarts at a checkpoint.

**Exit state:** The rescued communities agree to cooperate, but only after the party asks them what help they need. The Black Gate to Kurohana can now be opened from both sides.

## Chapter 8 — Lanterns Unhidden

**Quest:** Coordinate the Lantern Network’s breach of Kurohana without turning it into another army of expendable people.

**Places:** revisited Hoshigawa, Sodegaura, Takamine; Black Gate causeway; outer court barracks.
...
**Quest:** Break the Yearless Bell, defeat Kurozane, and prevent the castle’s records from consuming its prisoners.

**Places:** Kurohana outer archive; living audience hall; blood conservatory; bell spine; throne observatory.
