...
- preserve the integrated editable ten-pose party field, party combat, eight-expression portrait, seven-pose eight-family regular-enemy, seven-pose ten-boss, nine-family battle-VFX, six-status apply/active/expire, and metadata-only two-role NPC foundations; complete the missing in-betweens, alternate action facings, variants, full NPC roster, emitted Campaign heal, Campaign Dodge presentation, and defeat-canvas feedback before final art lock;
