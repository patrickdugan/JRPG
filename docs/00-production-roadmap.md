...
- preserve the integrated editable ten-pose party field, party combat, eight-expression portrait, seven-pose eight-family regular-enemy, seven-pose ten-boss, and nine-family battle-VFX foundations; complete the missing in-betweens, alternate action facings, variants, and remaining status/system effects before final art lock;
