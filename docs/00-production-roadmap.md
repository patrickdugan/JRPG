...
- preserve the integrated editable party field/combat/eight-expression portrait foundations, six-pose eight-family regular-enemy atlas, seven-pose ten-boss atlas, and nine-family battle-VFX overlay; complete the missing in-betweens, alternate facings, variants, and remaining status/system effects before final art lock;
