...
- preserve the integrated editable party field/combat/eight-expression portrait foundations, eight-family regular-enemy atlas, ten-boss key-pose atlas, and nine-family battle-VFX overlay; complete the missing in-betweens, alternate facings, variants, dedicated remaining enemy/boss recovery art, and remaining status/system effects before final art lock;
