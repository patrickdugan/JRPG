...
const CONDITION_RULES = Object.freeze({
  ...
  'boss-resolved': all(encounter('c1-tithe-hound', 'Resolve the Tithe Hound encounter')),
  ...
  'lise-key-used': all(interaction('rear-lock', 'Unlock the rear lock with Nikola\'s key')),
  'inspect-varga-mark': all(interaction('varga-mark', 'Inspect the Dražanić mark')),
  ...
  'kaji-disarmed-and-witnesses-safe': all(encounter('c3-captain-kaji', 'Disarm Captain Kaji while keeping both witnesses safe')),
  ...
  'widow-names-returned': all(encounter('c4-widow-of-fog', 'Release the Widow-of-Fog and return the sailors\' names')),
  ...
  'clerks-pursue': all(encounter('c6-ujiro', 'Resolve Ujiro\'s tribunal and trigger the clerks\' roof pursuit')),
  ...
  'all-prisoners-extracted': all(encounter('c7-bell-warden-chiyo', 'Extract every prisoner before the fourth bell count')),
  ...
  'six-offers-refused': all(
    ...
    interaction('lise-offer', 'Nikola refuses the offer'),
