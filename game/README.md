...
The current release manifest contains 135 byte-verified files and 10,163,010 delivered bytes: five pages, six stylesheets, five controllers, 86 modules, 32 PNG production assets, and one SVG favicon.
