...
The ordinary 80-scene narrative route has a 309.862-minute canonical reference plus 16.148 minutes for the longest visible Storyworld path, or 326.010 minutes (about 5.43 hours). The optional 215-activity route targets 20 hours at 1×. Duration audit v8 excludes authored minute labels and open-ended repeats; it estimates canonical content at 187.202/309.862/500.458 minutes and the all-finite route at 777.840/1,233.679/1,920.559 minutes low/reference/high. The optional reference clears 20 hours by 33.679 minutes. Only four measured repeat schedules accelerate, producing reference estimates of 1,233.372 minutes at 2× and 1,233.219 at 4×. This arithmetic is not observed playtime; both targets require human receipts.

The bounded `canonical-run.mjs` audit proves mechanical completion without pretending to prove duration: one deterministic zero-time run covers 60 beats, 2,748 dialogue lines, 59 choices, 60/60 scene operations, 183/183 operation nodes, 34 route chains, 1,429 legal field moves, 239 interactions, 41 exits, 23 first clears, 231 player commands, 97 enemy activations, and 17 safehouse rests. Its stable signature is `fnv1a32:2a3c2402`; its run receipt correctly reports `durationProven: false`.
