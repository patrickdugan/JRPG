...
The current release manifest contains 124 byte-verified files: five pages, six stylesheets, five controllers, 79 modules, 28 PNG production assets, and one SVG favicon.
