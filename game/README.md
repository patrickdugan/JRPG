...
The current release manifest contains 139 byte-verified files and 10,291,164 delivered bytes: five pages, six stylesheets, five controllers, 89 modules, 33 PNG production assets, and one SVG favicon.
