...
The current release manifest contains 87 byte-verified files: five pages, five stylesheets, five controllers, 66 modules, five PNG production assets, and one SVG favicon.
