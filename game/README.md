...
The current release manifest contains 137 byte-verified files and 10,204,105 delivered bytes: five pages, six stylesheets, five controllers, 88 modules, 32 PNG production assets, and one SVG favicon.
