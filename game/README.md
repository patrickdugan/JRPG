...
The ordinary 82-scene narrative route has a 312.481-minute canonical reference plus 18.245 minutes for the longest visible Storyworld path, or 330.726 minutes (about 5.51 hours). The optional 215-activity route targets 20 hours at 1×. Duration audit v8 excludes authored minute labels and open-ended repeats; it estimates canonical content at 188.936/312.481/504.237 minutes and the all-finite route at 779.587/1,236.311/1,924.351 minutes low/reference/high. The optional reference clears 20 hours by 36.311 minutes. Only four measured repeat schedules accelerate, producing reference estimates of 1,235.998 minutes at 2× and 1,235.841 at 4×. This arithmetic is not observed playtime; both targets require human receipts.

The bounded `canonical-run.mjs` audit proves mechanical completion without pretending to prove duration: one deterministic zero-time run covers 60 beats, 2,768 dialogue lines, 59 choices, 60/60 scene operations, 183/183 operation nodes, 34 route chains, 1,428 legal field moves, 239 interactions, 41 exits, 23 first clears, 231 player commands, 98 enemy activations, and 17 safehouse rests. Its stable signature is `fnv1a32:462b7ff8`; its run receipt correctly reports `durationProven: false`.
