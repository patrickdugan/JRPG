...
const CONTENT = {
  'lise-mateus': [
    scene({
      ...
      theme: 'Nikola establishes that recognition, useful intelligence, and temporary cooperation do not convert Mateus into a trusted witness.',
      ...
      second: { label: 'Permit one bounded exchange', direction: 'One private exchange may occur, but Nikola sets the subject and may end it without explanation' },
      topics: [
        topic('the grave-page recognition', 'Mateus spoke the Dražanić name before Nikola showed him the surviving page', 'recognition gives me a question, not kinship and not permission', 'I learned that name while serving people who profited from its disappearance', 'I will list where I saw the page, who handled it, and every uncertainty in my memory'),
        ...
        topic('the first night boundary', 'Nikola still sleeps with the Dražanić page inside his coat and his weapon outside its wrapping', 'I need distance that cannot be mistaken for theatrical mercy', 'distance is appropriate, and fear of me does not become unfair merely because I am useful', 'I will take the outer watch, keep my hands visible, and answer only questions you choose to ask'),
      ],
    }),
    scene({
      title: 'Distance at the Salt Fire',
      theme: 'After Sodegaura, Nikola and Mateus distinguish taking a perpetrator alive for testimony from preserving him for strategic convenience.',
      ...
      topics: [
        ...
        topic('the hunter word useful', 'a dock guard called Nikola useful after seeing his spear break a patrol line', 'hunters also hide behind usefulness when they want no questions about whom they target', 'the court praised my usefulness for the same reason: a tool is excused from choosing', 'I will refuse that excuse whenever strategy turns either of us into an instrument without judgment'),
        topic('the fire between bedrolls', 'Nikola placed the salt fire between himself and Mateus rather than ordering him away', 'distance can be a boundary without becoming banishment performed for an audience', 'remaining near enough to answer is not entitlement to warmth or companionship', 'I will keep the fire between us and submit the customs reconstruction before dawn'),
      ],
    }),
    scene({
    ...
    scene({
      ...
      theme: 'After Hushroad, Nikola tests his revised oath while Mateus refuses to become evidence of his moral improvement.',
      prompt: 'Who should review the revised Dražanić oath before it enters Aya casebook?',
      ...
      second: { label: 'Publish a draft with objections', direction: 'The draft should travel with Nikola and Mateus objections visibly attached for public revision' },
      topics: [
        topic('the named-person promise', 'Nikola now promises protection to named people rather than war against a lineage', 'the new object of the oath must be consent and safety, not my image of a worthy victim', 'that change matters because it removes my body from the center of your moral drama', 'I will help identify language that makes protection conditional on gratitude or resemblance'),
        topic('the refusal of proof', 'Mateus told Nikola not to write him into the oath as proof of his mercy', 'I was angry because the warning was accurate before I had admitted it to myself', 'accuracy gives me no ownership over the oath and no right to demand a gracious response', 'I will offer objections only when asked and will not appear in the final text as an exception'),
        ...
        topic('the watcher at the lantern', 'Nikola noticed Mateus guarding the survivor route without asking anyone to observe him', 'unwitnessed help may be sincere, but sincerity is still not the measure', 'the measure is whether the route remained open and whether survivors retained choices', 'I will report the route condition, not the fact that I happened to stand there'),
      ],
    }),
    scene({
      title: 'The Door Left Open',
      theme: 'With Kurohana broken, Nikola and Mateus assess a protective rite that opened the final ward without converting sacrifice into absolution.',
      ...
      topics: [
        topic('the ward cracked at dawn', 'Mateus used his blood to expose Kurozane ward while Nikola held the path behind him', 'a costly act can be necessary without purchasing a different past', 'pain is not payment when the debt belongs to people who did not choose the exchange', 'I will describe the ward mechanism and refuse any memorial language that calls the act redemption'),
        topic('the hand not taken', 'Nikola offered Mateus balance after the rite but did not call the gesture forgiveness', 'helping someone stand can preserve a route without revising judgment about them', 'I accepted the hand because falling would have closed the door on those behind us', 'I will remember the gesture as coordination under danger, not a private pardon'),
        ...
        topic('the future boundary', 'the final battle ended but Mateus caches and Nikola hunting knowledge remain dangerous', 'both kinds of knowledge need consent, witnesses, and a right of refusal around their use', 'supervision must constrain me without turning you into my permanent jailer', 'I will inventory caches with local witnesses while you place your manuals under community control'),
      ],
    }),
    scene({
      title: 'Supervised Daylight',
      theme: 'At the open archive, Nikola and Mateus define an accountable future based on correction, supervision, and separable work rather than friendship.',
      prompt: 'What continuing arrangement should the public archive record for them?',
      first: { label: 'Maintain separate supervised duties', direction: 'Nikola defense teaching and Mateus cache work should remain separately supervised and publicly reviewable' },
      ...
      topics: [
        ...
        topic('the defense lesson ledger', 'Nikola plans to teach defense while leaving communities free to reject his methods', 'a lesson must include when not to draw a weapon and who decides that threshold', 'that boundary is one my court training deliberately removed from local hands', 'I will translate requests without turning them into recruitment or threat assessments'),
        topic('the absence of friendship', 'neither Nikola nor Mateus promises friendship at the testimony table', 'honesty about distance is kinder than a reconciliation demanded for public comfort', 'I can work beside your refusal without making your refusal a punishment', 'I will keep the work correctable and let any warmer relation remain unnecessary'),
      ],
    }),
  ],
  ...
  'lise-genta': [
    scene({
      ...
      theme: 'Nikola and Genta compare hunter training with military discipline while refusing the idea that skill removes personal judgment.',
      ...
      topics: [
        topic('the spear and shield line', 'Nikola thrust and Genta shield can control a lane without striking everyone inside it', 'control is dangerous language when the people in the lane have nowhere else to go', 'soldiers praise a held lane and forget to ask whether it was also an exit', 'we will mark a civilian route before each drill and lose the exercise if we close it'),
        topic('the inherited target', 'Nikola training named bloodlines while Genta training named enemy units', 'both names can make an individual disappear inside an approved category', 'unit language let me punish a group for one action without asking who chose it', 'we will identify behavior, immediate threat, and surrender path instead of inherited labels'),
        ...
        topic('the useful foreign weapon', 'port brokers praised Nikola’s reach as if his origin explained his skill', 'exotic praise makes a person into equipment while avoiding what he believes', 'military praise did the same by reducing soldiers to functions in formation', 'we will describe technique plainly and ask before adapting it for another group'),
      ],
    }),
    scene({
    ...
    scene({
      ...
      theme: 'Former soldiers test whether Nikola and Genta can offer safety without recruiting them into a hunter campaign or renewed command.',
    ...
    scene({
      ...
      theme: 'In the repaired world, Nikola and Genta design defense teaching that includes disobedience, withdrawal, and community authority.',
      ...
      topics: [
        ...
        topic('the community-owned armory', 'Nikola does not want his family weapons to become a private Dražanić school', 'knowledge should stay local enough that people can refuse my presence later', 'central armories gave my officers leverage over every village defense choice', 'we will place tools under a rotating council with public inventory and withdrawal rules'),
        ...
        topic('the instructors under review', 'Nikola and Genta agree that students may document and challenge their methods', 'our histories make review necessary, not insulting', 'expertise becomes dangerous when gratitude protects it from correction', 'we will publish criticism beside lesson notes and step aside when the council asks'),
      ],
    }),
  ],
