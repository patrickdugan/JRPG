...
const entries = [
  ...
  copy('tkm-abandoned-chapel', 'hidden-key-screen', 'Disturbed paper screen', 'The shifted screen reveals the route Lise used to reach the rear lock.'),
  copy('tkm-abandoned-chapel', 'rear-lock', 'Rear service lock', 'Lise’s stolen key opens the rear service route.'),
  ...
  copy('tkm-bell-stair', 'varga-mark', 'Varga route mark', 'Lise records the mark and confirms that her family’s trail reached Takamine.'),
  ...
  copy('ngi-wrecked-carrack', 'varga-journal', 'Varga voyage journal', 'The journal records the Varga route and its failures without turning inheritance into authority.'),
  copy(
    'ngi-wrecked-carrack',
    'survivor-hold',
  ...
  copy('ngi-wrecked-carrack', 'reliquary-lock', 'Varga Strongbox', 'The Varga Strongbox yields a documented lead toward the second bell key.'),
  ...
  copy('krh-blood-conservatory', 'lise-offer', 'Lise’s court offer', 'Lise refuses to turn her inherited oath into authority over local lives.'),
