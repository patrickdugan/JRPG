...
export class CombatEngine {
  ...
  start() {
    ...
    this.turnNumber = 0;
    this._appendLog('Ren reaches Takamine with Elisabet “Lise” Varga, heir to a hunter oath.', 'scene');
    this._appendLog('Father Mateus Avelar’s seal marks the court’s orders; Lise knows the name.', 'scene');
  ...
  _checkOutcome() {
    if (this.enemy.hp <= 0) {
      ...
      this.message = 'The banner falls. Lise sees Mateus’s seal beneath the lacquer.';
