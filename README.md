...
Release verification on the integrated snapshot passes 459/459 tests, byte-exact localhost delivery for all 84 shipped browser files, and an isolated Chrome flow covering a fresh one-click route entry, persisted keyboard archive advance, real 4× repeat victory, cross-page persistence, the 215/215 credits gate, sealed-report download with zero unattributed time, denied-storage startup, keyboard reachability, and zero console/page/HTTP errors.
